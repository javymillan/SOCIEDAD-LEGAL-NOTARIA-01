...
function generatePreview() {
    ...
    preview.innerHTML = `
        ...
        <p>PRIMERO. La parte mínima fija del capital social se constituye por la cantidad de $${formatCurrency(data.capitalFijo)}, conforme a lo siguiente:</p>
...
function generateAportacionesPreview(data) {
    ...
    sociosData.forEach(socio => {
        html += `<tr>
            ...
            <td style="padding: 0.5rem; border: 1px solid var(--gray-300);">$${formatCurrency(socio.aportacion)}</td>
